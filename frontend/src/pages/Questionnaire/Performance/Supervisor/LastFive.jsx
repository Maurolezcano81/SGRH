...
const LastFive = () => {
    ...
    const urlGetData = `${process.env.SV_HOST}${process.env.SV_PORT}${process.env.SV_ADDRESS}${process.env.G_LAST_FIVE_PERFORMANCE_QUIZ}`
                    ...
                    <div className="not__answer__item" key={index}>
                        ...
                        <div className="not__answer__header">
                            <div className="not__answer__header__profile">
                                <p className="bold">{item.name_ep}</p>
                            </div>
                        </div>

                        <div className="not__answer__body__description">
                            <p className="color-black">{`Fecha de Inicio: ${item.start_ep}`}</p>
                            <p className="color-black">{`Fecha de Fin: ${item.end_ep}`}</p>
