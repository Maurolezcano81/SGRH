...
const ButtonDepartmentMoves = () => {
    ...
    const urlYears = `${process.env.SV_HOST}${process.env.SV_PORT}${process.env.SV_ADDRESS}${process.env.RALL_SUMMARY_YEARS_MOVEMENTS_ON_DEPARTMENT_BY_YEAR}`;
    const urlData = `${process.env.SV_HOST}${process.env.SV_PORT}${process.env.SV_ADDRESS}${process.env.RALL_SUMMARY_MOVEMENTS_ON_DEPARTMENT_BY_YEAR}`;
    ...
    const generatePDF = () => {
        ...
        doc.setFontSize(12);
        doc.text(`Reporte de Movimiento en los departamentos - Año ${selectedYear}`, 10, 20); // x, y

        doc.setFontSize(8);
        doc.text("Este es un informe detallado de los movimientos en los departamentos registrados en el sistema en el año..", 10, 40);
        doc.text("Este informe muestra las altas y bajas de los departamentos en el año que fueron cargados al sistema.", 10, 50);
        doc.text(`Reporte generado el: ${day}/${month}/${year} a las ${hour}:${minutes}`, 10, 60)

        doc.autoTable({
            head: [['Departamento', 'Altas', 'Bajas', 'Diferencia']],
        ...
        doc.save(`Reporte_Movimientos_${selectedYear}.pdf`);
    };
    useEffect(() => {
    ...
    return (
        <div className='report__container'>
            ...
            <div className='report__title__container'>
                ...
                <button onClick={toggleModal} className='report__button__title'>Rotación de Departamentos</button>
            </div>
            {showModal && (
...
export default ButtonDepartmentMoves;
